...
public enum VCPCode {
     ...
     * <li>Care should be taken to avoid the situation where the contrast ratio approaches 0 â€¦ this may be non-recoverable since user will not be able to see the image.</li>
     * </ol>
     */
     ...
     * The +- 7Fh range must be linearly mapped to the actual adjustment range.
     */
    SIX_AXIS_SATURATION_CONTROL_YELLOW(0x5A, VCPCodeType.READ_WRITE, VCPCodeFunction.CONTINOUS, Helper.POSITIVE_TWO_BYTES),
    /**
     ...
     * The +- 7Fh range must be linearly mapped to the actual adjustment range.
     */
    SIX_AXIS_SATURATION_CONTROL_GREEN(0x5B, VCPCodeType.READ_WRITE, VCPCodeFunction.CONTINOUS, Helper.POSITIVE_TWO_BYTES),
    /**
     ...
     * The +- 7Fh range must be linearly mapped to the actual adjustment range.
     */
    SIX_AXIS_SATURATION_CONTROL_CYAN(0x5C, VCPCodeType.READ_WRITE, VCPCodeFunction.CONTINOUS, Helper.POSITIVE_TWO_BYTES),
    /**
     ...
     * The +- 7Fh range must be linearly mapped to the actual adjustment range.
     */
    SIX_AXIS_SATURATION_CONTROL_BLUE(0x5D, VCPCodeType.READ_WRITE, VCPCodeFunction.CONTINOUS, Helper.POSITIVE_TWO_BYTES),
    /**
     ...
     * The +- 7Fh range must be linearly mapped to the actual adjustment range.
     */
    SIX_AXIS_SATURATION_CONTROL_MAGENTA(0x5E, VCPCodeType.READ_WRITE, VCPCodeFunction.CONTINOUS, Helper.POSITIVE_TWO_BYTES),
    /**
     ...
     * </tbody></table>
     */
    DISPLAY_APPLICATION(0xDC, VCPCodeType.READ_WRITE, VCPCodeFunction.NON_CONTINOUS, new int[]{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0xF0});
